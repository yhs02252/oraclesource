...
--SELECT 입력 가능한 문자 => GROUP BY 쓰여진 컬럼 하나, 또는 다중행함수
...
--인덱스 : 빠른 검색
--1) 자동 생성 : 기본키(PK)를 설정 시 인덱스로 자동 설정 됨
--2) 직접 인덱스 생성
...
--제약 조건: 특정 열에 지정
--1) NOT NULL : 지정한 열에 NULL 을 혀용하지 않음
--2) UNIQUE : 지정한 열이 유일한 값을 가져야함
--3) PRIMARY KEY : 지정한 열이 유일한 값이면서 NULL을 허용하지 않음(테이블당 하나만 지정가능)
...
--NULL을 ("SCOTT"."TALBE_NOTNULL"."LOGIN_PWD") 안에 삽입할 수 없습니다
--INSERT INTO TALBE_NOTNULL VALUES ('TEST_ID_01', NULL, '010-1234-5678');
INSERT INTO TABLE_NOTNULL VALUES ('TEST_ID_01', 'TEST_PWD_01', NULL);

--NULL로 ("SCOTT"."TALBE_NOTNULL"."LOGIN_PWD")을 업데이트할 수 없습니다
...
CREATE TABLE TABLE_NOTNULL2(
	LOGIN_ID VARCHAR2(20) CONSTRAINT TBLNN2_LGNIN_NN NOT NULL,
...
UPDATE TABLE_UNIQUE SET TEL = '010-4567-5689' WHERE LOGIN_ID = 'TEST_ID_01';
...
--PRIMARY KEY(PK - 기본키) : NOT NULL + UNIQUE
--기본키 : 주민등록번호, 사원번호, 아이디
--※하나의 컬럼만 지정 가능
...
--DEPT 테이블의 DEPTNO 값을 기반으로 EMP테이블의 DEPTNO값 삽입
...
--무결성 제약조건(SCOTT.EMPFK_DEPTNO_FK)이 위배되었습니다- 부모 키가 없습니다 ==>부모부터 값이 들어가 있어야함
INSERT INTO DEPT_FK VALUES (50,'DATABESE','SEOUL');
INSERT INTO DEPT_FK VALUES (10,'NETWORK','BUSAN');
INSERT INTO EMP_FK VALUES (9999,'테스트','CLERK', '7788','2017-04-30',1200,NULL,50);

--무결성 제약조건(SCOTT.EMPFK_DEPTNO_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다 ==>자식에게 들어가있는 값을 처리리해야함
...
--ON DELETE CASCADE : 부모 데이터 삭제 시 참조하고 있는 자식 데이터도 같이 삭제
...
INSERT INTO TABLE_CHECK VALUES ('TEST_ID_-1','12',NULL);
...
INSERT INTO TABLE_DEFAULT  VALUES ('TEST_ID_-1',NULL,NULL);
INSERT INTO TABLE_DEFAULT(LOGIN_ID, TEL)  VALUES ('TEST_ID_-2',NULL);

...
SELECT DEPTNO , TO_CHAR(HIREDATE, 'YYYY') AS "입사년도", COUNT(*) AS "인원수" FROM EMP e GROUP BY DEPTNO ,TO_CHAR(HIREDATE, 'YYYY') ORDER BY DEPTNO ASC;
...
--(JOIN시 동일한 필드명을 가지고 있다면 열의 정의가 애매합니다라고 뜬다)
